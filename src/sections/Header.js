            ...
            <div className='flex items-center justify-start lg:justify-between py-8 md:px-[4em] lg:px-[7em] px-7 bg-[#00152a] h-[12em]'>
                <div className='flex cursor-pointer items-center font-[Poppins] text-gray-800 h-full'>
                    <div className='z-50 h-full flex items-center cursor-pointer' onClick={() => navigate('/')}>
                        <img src="img/LogoBigFood.png" className='w-[9em]'>
                        </img>
                    </div>
                </div> 
                ...
                <ul className={`lg:flex lg:items-center lg:pb-0 pt-[10em] lg:pt-0 pb-12 absolute lg:static bg-[#00152a] lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-1000 ease-in ${open ? 'top-20 opacity-100':'top-[-490px]'} lg:opacity-100 opacity-0`}>
                    {
                        links.map((link)=>(
