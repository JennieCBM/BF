    ...
    return (
        <header className='shadow-md w-full fixed top-0 left-0 relative tracking-widest '>
            ...
            <div className='flex items-center justify-start lg:justify-between py-8 md:px-[4em] lg:px-[7em] px-7 bg-[#00152a] h-[12em] '>
                ...
                <ul className={`lg:flex lg:items-center lg:pb-0 lg:pt-0 pb-12 absolute lg:static bg-[#00152a] left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-1000 ease-in ${open ? 'top-[100%] opacity-100':'top-[-490px]'} lg:opacity-100 opacity-0 med-z`}>
                    {
                        links.map((link)=>(
