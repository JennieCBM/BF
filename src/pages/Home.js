...
const Home = () => {
    return (
        <div className="w-[100vw]  pb-6">
            <div>
                <img src={`${process.env.PUBLIC_URL}/img/home_burger.png`} alt="burger" className='lg:w-[100%]'/>
            </div>
            <div className="px-6 lg:px-[15%] lg:py-[5%]">
                <div className="grid grid-col-1 lg:grid-cols-2 gap-4">
                    <div className="">
                        <div className="text-xl sm:text-2xl tracking-widest whitespace-nowrap max-w-[100%] ">
